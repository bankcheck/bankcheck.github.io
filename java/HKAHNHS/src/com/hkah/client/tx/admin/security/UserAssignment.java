...
public class UserAssignment extends ShufflePanel {
	...
	public String getTxCode() {
		...
		return ConstantsTx.USERASSIGNMENT_TXCODE;
	}

	/* >>> ~2~ Set Transaction Title ====================================== <<< */
	@Override
	public String getTitle() {
		return ConstantsTx.USERASSIGNMENT_TITLE;
	}
...
//		((Sorter) getLeftListTable().getModel()).setSortingStatus(1, TableSorter.ASCENDING);
