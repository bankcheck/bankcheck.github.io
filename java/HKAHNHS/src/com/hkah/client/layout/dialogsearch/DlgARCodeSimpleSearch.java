...
public class DlgARCodeSimpleSearch extends DialogSearchBase {

	/* >>> ~1~ Set Transaction Code ======================================= <<< */
	@Override
	public String getTxCode() {
		return ConstantsTx.AR_CODETYPE_TXCODE;
	}
	...
	*
	*/
	public DlgARCodeSimpleSearch(SearchTriggerField textfField) {
		super(textfField);
	}
	...
	protected String[] getBrowseInputParameters() {
		return new String[] {
				...
				getArCompany().getText().trim(),
				getPhoneNumber().getText().trim(),
				getContactPerson().getText().trim()
			};
	}
	...
	protected boolean isSearchFieldsEmpty() {
		return getArCode().isEmpty()
			&& getArCompany().isEmpty()
			&& getPhoneNumber().isEmpty()
			&& getContactPerson().isEmpty();
	}
	...
	public LabelSmallBase getArCodeDesc() {
		if (arCodeDesc == null) {
			...
			arCodeDesc.setBounds(54, 18, 120, 20);
		}
		return arCodeDesc;
	}
	...
	public TextString getArCode() {
		if (arCode == null) {
			...
			arCode.setBounds(159, 18, 120, 20);
		}
		return arCode;
	}
