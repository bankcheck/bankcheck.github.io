...
public class DlgSecCheck extends DialogBase implements ConstantsVariable {
	...
	public DlgSecCheck (MainFrame owner) {
	...
	public void showDialog(String otlid) {
		this.OTLID = otlid;
			...
			public void onPostSuccess(MessageQueue mQueue) {
				if (mQueue.success()) {
					QueryUtil.executeTx(getUserInfo(), "ACT_LOGON_SECHK",
						...
						public void onPostSuccess(MessageQueue mQueue) {
							if (mQueue.success()) {
								QueryUtil.executeMasterAction(getUserInfo(), "ROPNOTLG", QueryUtil.ACTION_MODIFY,
										new String[] { usr1,usr2, OTLID },
										new MessageQueueCallBack() {
									@Override
									public void onPostSuccess(MessageQueue mQueue) {
										if (!mQueue.success()) {
