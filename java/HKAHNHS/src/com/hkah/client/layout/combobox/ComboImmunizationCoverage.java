...
public class ComboImmunizationCoverage extends ComboBoxBase {
	...
	public ComboImmunizationCoverage() {
		super(false);
		initContent();
	}
/*
	public void initContent() {
		...
		// initial combobox
		resetContent(ConstantsTx.IMMUNIZATIONCOVERAGE_TXCODE, false, true);
		resetText();
	}
*/
