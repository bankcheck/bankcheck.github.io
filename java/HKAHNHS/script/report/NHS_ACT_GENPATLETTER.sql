create or replace FUNCTION NHS_ACT_GENPATLETTER (
S_PATNO IN VARCHAR2,
...
BEGIN
  ...
  */
  ...
  EXIT WHEN C_RS1%NOTFOUND;
    ...
    V_PATNO,V_SLPNO,V_PATNAME,V_PATFNAME,V_BEDCODE,V_TITDESC,V_REGDATE,V_SLPTYPE,V_ARCODE,VRS_OUTAMT,v_sysdate,V_BILLTYPE,'SYSTEM',SYSDATE,1);
