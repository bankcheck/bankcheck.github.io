CREATE OR REPLACE FUNCTION "NHS_RPT_CHRGSMYMB_CHGACM" (
	v_SLPNO    IN VARCHAR2,
...
BEGIN
	...
	SQLSTR := '
			SELECT MB, PATNAME, PATCNAME, SLPNO, PATNO, REGDATE, REGTIME, BEDACM, INPDDATE, INPDTIME, DOCNAME, DOCCNAME, BEDCODE, ACMNAME
			FROM (
