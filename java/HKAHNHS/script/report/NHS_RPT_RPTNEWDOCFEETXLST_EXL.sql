create or replace
FUNCTION "NHS_RPT_RPTNEWDOCFEETXLST_EXL"(
...
Begin
  ...
  a.STNID,
  A.Stnsts,
  to_char(A.Stncdate, ''fmdd/MM/yyyy'') Stncdate,
  A.Itmcode,
  A.Stndesc,
  A.Stnbamt,
  A.Stndisc,
  ...
  A.Dfx_Code,
  A.Stnoamt,
   to_char(a.STNTDATE, ''fmdd/MM/yyyy'') STNTDATE,
  ...
  RETURN OUTCUR;
END NHS_RPT_RPTNEWDOCFEETXLST_EXL;
/
