create or replace FUNCTION NHS_ACT_GENALLPATLETTER (  
...
JOIN INPAT B ON B.INPID = C.INPID AND B.INPDDATE IS NULL
      ...
      IF TMPARCODE = TRUE THEN -- NO ARCODE: TRUE
        ...
        IF VTMPSQL_CNT>0 THEN
          ...
          IF VTMPSQL1_CNT > 0 THEN
            ...
            IF TMPRS_CNT>0 THEN  
                RTN_CODE :=NHS_ACT_GENPATLETTER(V_PATNO ,VOUTAMT, NULL, VPREDAYS, 0, 0, V_REGDATE, V_SLPNO, V_SYSDATE, V_BILLTYPE); 
