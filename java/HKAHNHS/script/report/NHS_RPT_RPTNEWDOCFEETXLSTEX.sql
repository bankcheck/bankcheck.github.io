create or replace
FUNCTION "NHS_RPT_RPTNEWDOCFEETXLSTEX"(
...
Begin
  ...
  and (
  (a.stnBAMT<a.DFX_SAMT or a.stnBAMT<0) 
   or ((a.DFX_CAMT - a.COMMISSION)>a.DFX_SAMT or (a.DFX_CAMT - a.COMMISSION)<0 )
   or (a.DFX_CAMT>a.DFX_SAMT or a.DFX_CAMT<0)
   or (a.DFX_SAMT<0)
  )
  order by a.STNTDATE, a.PATNO';
  OPEN OUTCUR FOR STRSQL;
  RETURN OUTCUR;
END NHS_RPT_RPTNEWDOCFEETXLSTEX;
/
