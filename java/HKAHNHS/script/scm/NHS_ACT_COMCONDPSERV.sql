CREATE OR REPLACE FUNCTION "NHS_ACT_COMCONDPSERV"(V_ACTION     IN VARCHAR2,
                                                  V_CID        IN VARCHAR2,
                                                  V_PCYID      IN VARCHAR2,
...
BEGIN
  O_ERRCODE := 0;
  O_ERRMSG  := 'OK';
  SELECT COUNT(1) INTO V_NOOFREC FROM CMCDPS WHERE CID = V_CID;
