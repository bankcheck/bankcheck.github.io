CREATE OR REPLACE FUNCTION "NHS_ACT_SLPPAYALLREVERSE" (
...
BEGIN
	...
	IF i_Action = 'ADD' THEN
		...
		o_errcode := NHS_UTL_SLPPAYALLREVERSE(i_SpdID, v_CaptureDate, v_UserCancel, null);
		IF o_errcode < 0 THEN
			o_errcode := -1;
