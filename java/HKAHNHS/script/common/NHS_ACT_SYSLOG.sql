CREATE OR REPLACE FUNCTION NHS_ACT_SYSLOG (
	i_ACTION    IN VARCHAR2,
	i_MODULE    IN VARCHAR2,
	i_LOGACTION IN VARCHAR2,
...
BEGIN
	...
	VALUES (i_MODULE, i_LOGACTION, i_REMARK, i_USERID, SYSDATE, v_PCNAME);

	RETURN O_ERRCODE;
EXCEPTION
WHEN OTHERS THEN
	ROLLBACK;
	O_ERRMSG := 'Fail to add log.';
