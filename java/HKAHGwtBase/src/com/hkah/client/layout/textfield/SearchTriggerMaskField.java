...
public abstract class SearchTriggerMaskField extends SearchTriggerField implements ConstantsVariable{
	...
	public SearchTriggerMaskField() {
		super();
	}

	public SearchTriggerMaskField(String mask) {
		super();
		this.mask = mask;
	}

	public SearchTriggerMaskField(boolean hideSearchTrigger) {
		super(hideSearchTrigger);
	}

	public SearchTriggerMaskField(boolean hideSearchTrigger, String mask) {
		super(hideSearchTrigger);
		this.mask = mask;
	}
