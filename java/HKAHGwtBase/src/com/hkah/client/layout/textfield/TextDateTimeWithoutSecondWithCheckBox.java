...
public class TextDateTimeWithoutSecondWithCheckBox extends MultiField<TextDateTimeWithoutSecond> {

	private final CheckBoxBase cbFuncField;
	private final TextDateTimeWithoutSecond dateField;

	public TextDateTimeWithoutSecondWithCheckBox() {
		super();
		...
		cbFuncField = new CheckBoxBase() {
			...
			public void onClick() {
				super.onClick();
				if (isSelected()) {
					dateField.setText(Factory.getInstance().getMainFrame().getServerDateTime());
				} else {
					dateField.resetText();
				}
			}
		...
		dateField = new TextDateTimeWithoutSecond();
	...
	public TextDateTimeWithoutSecond getDateField() {
		return dateField;
	}
