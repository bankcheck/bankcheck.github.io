...
/**
 * The async counterpart of <code>Report</code>.
 */
public interface ReportServiceAsync {

	void print(UserInfo ui, String prtName, Map<String, String> rptparam, String patcname, 
	...
	void print(UserInfo ui, String[] rptparam, Map<String, Map<String, String>>map, String[] patcname, 
	...
	void  getDocFeeRptList(String path, String[] exts, AsyncCallback<MessageQueue> callback);
}
