...
/* 
 * Modified by Ricky Leung (HKAH) based on jasperreports-4.0.1
 * 2014-11-18
 * 
 * Fix export pdf file to other systems
 */
 ...
 * @version $Id: JRPdfExporter.java,v 1.1 2014/11/19 01:40:46 ricky.leung Exp $
 */
public class JRPdfExporter extends JRAbstractExporter
{
	...
	public void exportReport() throws JRException
	{
		...
		try
		{
			...
			System.out.println("[DEBUG] JRPdfExporter exportReport");
			...
			else
			{
				...
				{
					//----------------------------
					// Original source jasperreport-4.0.1 
					//os = new FileOutputStream(destFile);
					//----------------------------
					
					//----------------------------
					// Modified by Ricky Leung
					os = FileIoUtil.getOutputStream(destFilePath);
					//----------------------------
