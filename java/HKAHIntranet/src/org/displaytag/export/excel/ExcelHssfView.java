 ...
 * @author rapruitt
 * @version $Revision: 1.9 $ ($Author: johnny $)
 */
public class ExcelHssfView implements BinaryExportView
{
    ...
    public void doExport(OutputStream out) throws JspException
    {
        try
        {
            ...
            if (this.header)
            {
                ...
                headerStyle.setFillForegroundColor(new HSSFColor.GREY_50_PERCENT().getIndex());
                ...
                while (iterator.hasNext())
                {
                    ...
                    // solve UTF-8 wrong encoding 
                    //cell.setCellValue(new org.apache.poi.hssf.usermodel.HSSFRichTextString(columnHeader));
                    cell.setCellValue(new String(columnHeader));
    ...
    protected void writeCell(Object value, HSSFCell cell)
    {
        ...
        else
        {
        	...
        	cell.setCellValue(new String(escapeColumnValue(value)));
        }
    }
