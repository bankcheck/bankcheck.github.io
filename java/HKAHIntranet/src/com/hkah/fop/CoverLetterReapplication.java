...
public class CoverLetterReapplication {
...
//		String imgLink = "C:\\Program Files\\Apache Software Foundation\\Tomcat 6.0\\webapps\\intranet\\images\\hkah_bilin.jpg";
		String imgLink = "C:\\projects\\HKAHIntranet\\WebContent\\images\\hkah_bilin.jpg";
		...
		printWrite2XML.println("		<fo:region-body margin-top=\"0.5cm\"/>	");
...
*/
				printWrite2XML.println("		<fo:external-graphic src=\"url("+ imgLink + ")\" width=\"192px\" height=\"69px\"/>");
				printWrite2XML.println("		<fo:block text-align=\"left\" space-after.optimum=\"" + defaultSpace + "pt\">	");
				printWrite2XML.println(MessageResources.getMessageEnglish(dateFormat.format(currentDate)));
				printWrite2XML.println("	");
				printWrite2XML.println(MessageResources.getMessageEnglish(docGName)+", "+MessageResources.getMessageEnglish(docFName));
				...
				printWrite2XML.println("	");
				printWrite2XML.println(MessageResources.getMessageEnglish("Dear Dr. " + docFName));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
//				printWrite2XML.println(MessageResources.getMessageSimplifiedChinese(""));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content1"));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
//				printWrite2XML.println(MessageResources.getMessageSimplifiedChinese(""));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content2") + " " +
//									   MessageResources.getMessageEnglish(dateFormat.format(nextMthDate)) + " " +
										"5 March 2012 " +
									   MessageResources.getMessageEnglish("prompt.reappform.content3"));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\" font-weight=\"bold\">	");
//				printWrite2XML.println(MessageResources.getMessageSimplifiedChinese(""));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content4"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content8"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content9"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content10"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content11"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content12"));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content13"));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	 ");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
//				printWrite2XML.println(MessageResources.getMessageSimplifiedChinese(""));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content14"));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
//				printWrite2XML.println(MessageResources.getMessageSimplifiedChinese(""));
				printWrite2XML.println(MessageResources.getMessageEnglish("prompt.reappform.content15"));
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
				printWrite2XML.println("Sincerely");
				printWrite2XML.println("Medical Affairs Office");
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
				printWrite2XML.println("enc");
				printWrite2XML.println("		</fo:block>");
				printWrite2XML.println("	");
				printWrite2XML.println("		<fo:block text-align=\"left\">	");
				printWrite2XML.println("/el");
				printWrite2XML.println("		</fo:block>");
/*
				printWrite2XML.println("		<fo:block text-align=\"left\" space-after.optimum=\"" + defaultSpace + "pt\">	");
