...
*/
		...
		sqlStr.append("DECODE(P.MOTHCODE, 'TRC', 'zh-HK', 'SMC', 'zh-CN', 'JAP', 'jp', 'en'),P.RACDESC "); //24
...
//FTOCC methods
	...
	public static ArrayList getFTOCCData(String regid) {
		...
		sqlStr.append(" RB_Contact1, RB_Contact2, RB_Contact3 "); //20240207 add new fields 		
...
*/
	...
	public static ArrayList getPatRegHist(String patno, int intervalDate) {
		...
		sqlStr.append("	) AS FS_FILE_INDEX_ID, ROUND((SYSDATE-R.REGDATE)*24) as hrdiff   ");
