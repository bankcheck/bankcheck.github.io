...
public class NotifyPatientCovidTW implements Job {

	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		System.out.println("[NotifyPatientCovidTW] ===== Start =====");
		main();
		System.out.println("[NotifyPatientCovidTW] ===== End =====");
	}
	...
	private static ArrayList getList() {
		...
		sqlStr.append(" FROM V_HC_EMAIL_PENDING@LIS ");
	...
	public static File zipAttachment (String labnum, String report, String cert, boolean debug) {
		...
		System.out.println("[NotifyPatientCovidTW] tmpFolder= " + tmpFolder);
		...
		try {
			...
			System.out.println("[NotifyPatientCovidTW] srcRptPath = " + report + 							
			...
			try {
				...
				System.out.println("[NotifyPatientCovidTW] zip file error : " + e.getMessage() );
			    e.printStackTrace();
			}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private static String getEmail1Content(String patno, String rptDate, String labnum, boolean cert ) {
		...
		content.append("<b>檢測：新型冠状病毒核酸測試</b><br />");
		...
		content.append("<b>Test: SARS-CoV-2 RNA</b><br />");
	...
	private static boolean updateEmailErrorMsg(String labnum, String msg) {
		...
		sqlStr.append(" AND TEST_CAT in ('M', 'HC')");
