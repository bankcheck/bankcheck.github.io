...
(
    ...
    PO_DEPT_CODE VARCHAR2(10 BYTE), 
	PO_SHIP_TO VARCHAR2(10 BYTE),
	BUDGET_CODE VARCHAR2(30 BYTE),
...
DROP SEQUENCE "TWAH"."EPO_FOLDER_ID";
CREATE SEQUENCE "TWAH"."EPO_FOLDER_ID"  MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;