CREATE OR REPLACE FUNCTION "HAT_GET_DOCTORSCHEDULE" (
	i_DOCCODE VARCHAR2,
...
BEGIN
	...
	FROM   SCHEDULE@IWEB
	WHERE  STECODE = GET_CURRENT_STECODE@IWEB
	AND    SchNSlot <> 0
	AND    SCHSDATE >= TO_DATE(v_DATEFROM, 'DD/MM/YYYY HH24:MI:SS')
	AND    SCHEDATE <= TO_DATE(v_DATETO, 'DD/MM/YYYY HH24:MI:SS')
