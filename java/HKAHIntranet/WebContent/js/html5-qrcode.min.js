...
g.addEventListener("click",function(){g.disabled=!0,b.__setStatus("PERMISSION"),b.__setHeaderMessage("Requesting camera permissions..."),
	Html5Qrcode.getCameras().then(
			function(c){
				b.__setStatus("IDLE"),b.__resetHeaderMessage(),c&&0!=c.length?(e.removeChild(f),b.__renderCameraSelection(c)):
		...
		["catch"](function(c){
			...
			f.appendChild(g),e.appendChild(f);
						...
						h.style.display=this.currentScanType==a.SCAN_TYPE_CAMERA?"none":"block",d.appendChild(h);
