    ...
    ([function (e, n) {
                ...
                u = function () {
                    ...
                    t.prototype.buildEventDefs = function (t) {
                        ...
                        s = [];
                        for (!0 === n ? r = [{}
                            ] : i.isPlainObject(n) ? r = [n] : i.isArray(n) && (r = n, o = !0), e = 0; e < r.length; e++)
                ...
                H = function () {
                    ...
                    t.prototype.moment = function () {
                        for (var t = [], e = 0; e < arguments.length; e++)
                            t[e] = arguments[e];
                        var n;
                        return "local" === this.opt("timezone") ? (n = y.default.apply(null, t), n.hasTime() && n.local()) : n = "UTC" === this.opt("timezone") ? y.default.utc.apply(null, t) : y.default.parseZone.apply(null, t),
                    ...
                    t.prototype.footprintToDateProfile = function (t, e) {
                        ...
                        t.isAllDay ? (i.stripTime(), n && n.stripTime()) : (i = this.applyTimezone(i), n && (n = this.applyTimezone(n))),
                ...
                p = function (t) {
                    ...
                    e.prototype.handleMousedown = function (t, e) {
                        !d.default.get().shouldIgnoreMouse() && this.component.canStartDrag(t, e) && this.buildDragListener(t).startInteraction(e, {
                            distance: 5
                        })
                    },
                    e.prototype.handleTouchStart = function (t, e) {
                        ...
                        d.default.get().shouldIgnoreMouse() || (n.canStartDrag(t, e) ? this.buildDragListener(t).startInteraction(e, i) : n.canStartSelection(t, e) && this.buildSelectListener(t).startInteraction(e, i))
                    },
                ...
                u = function () {
                    ...
                    t.prototype.removeEventDef = function (t) {
                        ...
                        n && (r.removeExact(n, t), n.length || delete e[t.id],
