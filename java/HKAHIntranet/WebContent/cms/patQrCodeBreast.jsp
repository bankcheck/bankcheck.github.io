...
String myCodeText = "http://" + serverIP + "/intranet/healthAssessment/breast_assess_form.jsp?command=" + command + "&staffID=" + staffID + "&patNo=" + patNo + "&regID=" + regID + "&seqNo=" + seqNo +  "&formType=NORMAL";
