...
if("create".equals(command)){
	...
	System.out.println("Send Lab Email");	
	CMSDB.sendLabEmails();
}
...
<form name="search_form" action="lis_email_create_user.jsp" method="post" onsubmit="return submitSearch();">
<table>
	<tr>
		<td class="infoLabel">
			Enter HATS Code
...
<hr>
<br>
<% if(!CMSDB.drPortalAccExist(hatsSearchCode)){ %> 
<form name="create_form" action="lis_email_create_user.jsp" method="post">
<table>
	<tr>
		<td class="infoLabel">
			HATS Code
	...
	<tr>
		...
		<td class="infoData" >
			<input type="text" name="portalLoginID" value="<%=hatsSearchCode == null ? "" : "LAB-" + hatsSearchCode %>"  size="50" />
		</td>
	</tr>
	<tr>
		<td class="infoLabel">
