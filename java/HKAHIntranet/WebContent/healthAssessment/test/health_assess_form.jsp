...
%>
	...
	<tr>
 	...
 	<tr>
 	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="mn_p58" value="1" <%if ("1".equals(mn_p[58])) {%>checked<%} %>/>&nbsp;Arrange 安排/ <input type="checkbox" name="mn_p103" value="1" <%if ("1".equals(mn_p[103])) {%>checked<%} %>/>&nbsp;continue 繼續</td>
 	</tr>
 	<tr>
 	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;smoking cessation service 戒煙服務</td>
 	</tr>
 	<tr>
