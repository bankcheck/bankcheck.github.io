...
try{		
	...
	if(searchAction){
		...
		request.setAttribute("trackList", FsDB.getTodayList(userBean.getLoginID(), serverSiteCode));
	}else{	
...
<form name="search_form" action="fsMenuPastList.jsp" method="get">
<table id="fsMenuList" class="display" cellpadding="0" cellspacing="5" class="contentFrameMenu" border="0">
	<tr class="bigText">
		...
		<button class="ui-button ui-widget ui-state-default ui-button-text-only" 
					style="width:150px; height:60px;font-size:24px!important;" onclick="return submitAction('print');return false;">
			PAST
		</button>
		<button class="ui-button ui-widget ui-state-default ui-button-text-only" 
