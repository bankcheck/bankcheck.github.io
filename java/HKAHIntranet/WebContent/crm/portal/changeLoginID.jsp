...
<jsp:include page="title.jsp" flush="false">
	<jsp:param name="title" value="Change Login ID" />
</jsp:include>
...
<table cellpadding="0" cellspacing="5"
	...
	<tr class="smallText">
		...
		<td class="crmData2" width="70%"><html:text property="newLoginID" value="" size="20" maxlength="20"/></td>
	</tr>	
</table>
	...
	<tr class="smallText">
		<td align="center">
			<button type="submit" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only">
				<bean:message key="button.save" /> - Change Login ID
			</button>
		</td>
	</tr>
</table>
</html:form>
<bean:define id="newLoginIDLabel">Cannot have empty New Login ID</bean:define>
<script language="javascript">
	// validate signup form on keyup and submit
	$("#CRMChangeLoginIDForm").validate({
		event: "keyup",
		rules: {
			newLoginID: { required: true, minlength: 1 },
