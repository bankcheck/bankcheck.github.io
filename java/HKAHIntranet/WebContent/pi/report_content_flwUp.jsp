	...
	if (category.size() > 0) {
		...
		for(int i = 0; i < category.size(); i++) {
			...
			if (pirID != null) {
				...
				%>
					<jsp:include page="../pi/report_grpCatergory_flwUp.jsp" flush="false">
		...
		<div id="content_flwUp" style="width:75%; height:560px; background-color:white; float:right;">
			<div class='content-pane scroll-pane jspScrollable' style='overflow: hidden; padding: 0px; height:100%;'>
			</div>
		</div>
		<div id="content-container_flwUp" style="display:none"></div>
<%
	}
%>
	</div>
