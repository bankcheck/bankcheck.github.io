...
public static ArrayList getMaskUsageHKAH(String fromDate, String toDate) {
    ...
    sqlStr.append("    NVL(T1.MedicomGown40gBlue_03030060090, 0), NVL(T1.MedicomGown40gYel_03030000088, 0), NVL(T1.Aniosgel85NPC500ml_03284400206, 0), ");
    ...
    sqlStr.append("    NVL(Medicom_Gown_40g_blue,0) AS MedicomGown40gBlue_03030060090, NVL(Medicom_Gown_40g_yellow,0) AS MedicomGown40gYel_03030000088, NVL(Aniosgel_85_NPC_500ml,0) AS Aniosgel85NPC500ml_03284400206, ");
	...
	sqlStr.append("            '03010090050', '03012800047', '03012800336',"); 
	sqlStr.append("            '03010000094', '03010000112', '03010000010',"); 
	sqlStr.append("            '03010000033', '03010000019', '03012100020',");
	sqlStr.append("            '03012100169', '03010000207', '03012800197',");
    sqlStr.append("            '03030060090', '03030000088', '03284400206',");
	...
	sqlStr.append("            AND HU.AREA = 'HKAH'  ");	
	...
	sqlStr.append("    '03012100169' Three_M_Flat_fold_N95, '03010000207' Three_M_VFlex_N95_Regular, '03012800197' Three_M_VFlex_N95_Small, ");
    sqlStr.append("    '03030060090' Medicom_Gown_40g_blue, '03030000088' Medicom_Gown_40g_yellow, '03284400206' Aniosgel_85_NPC_500ml, ");
    sqlStr.append("    '03284400216' Anios_Scrub_Chlor_500ML, '03284400222' Anios_Airless_Scrub_1000ml, '03284400225' ThreeM_Avagard9250HandRub500ml)) order by 1 ");	
	sqlStr.append(") T1 ");
	...
	sqlStr.append("    WHERE PD.AREA = 'HKAH'  ");	
