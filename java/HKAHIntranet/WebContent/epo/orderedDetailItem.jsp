...
ArrayList al_epo = EPORequestDB.getApprRequestDtl(reqNo);
...
<display:table pagesize=""  requestURI="" class="tablesorter" name="EPO" sort="page" id="resList">
    ...
    <display:column style="width:22%;" title="Item Desc" >
		<div style="display:"";">
			...
			<input type="hidden" name="itemDesc[${resList_rowNum - 1}].fields3" value="${EPO[resList_rowNum - 1].fields3}" />		
		</div>
	</display:column>
	...
	<display:column style="width:8%; " title="Outstanding">	
		<div style="display:"";">
