...
if (count > startcount) { %>
	<td width="50%" align="center" valign="top" bgcolor="#EAF1DD"><div><table width="70%">
<%
...
%>
	<tr><td width="25"%" height="130">&nbsp;</td><td align="center" width="50"%" height="130"><font face="微軟正黑體" color="black"><p style="font-size:96px"><%=ticketNo %></p></font><td width="25"%" height="130">&nbsp;</td></td></tr>
<%
		if (i + 1 == startcount + (totalRecPerTable / 2)) {
%>
	</table></div></td><td width="50%" align="center" valign="top" bgcolor="#EAF1DD"><div><table width="70%">
<%
		}
	}
