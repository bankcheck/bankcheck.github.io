...
<table id="table1" width="100%" border="0">
	<tr>
		...
		<td width=<%=collen %>% style='background-color:#FCD5B5;opacity:0.9;' onclick='highlight(this, "1")'><center><font color='black' SIZE='6'>Ready for Payment</font></center></td>
<%	if (isNWStyle) { %>
...
<%	} %>
		<td width=<%=collen %>% style='background-color:#B3A2C7;opacity:0.9;' onclick='highlight(this, "3")'><center><font color='black' SIZE='6'>Payment Completed</font></center></td>
