...
<style>
ul.level1 li { background: url(../images/right2.gif) 0% 15% no-repeat; padding-left: 10px; }
ul.level1 h4 { font-size: 100%; font-weight: bold; margin: 5px 0; }
...
<form name="form1" method="post">
	<div id="staffEducationWrapper">
		<div id="contentPage">
			<div id="breadcrumb">
				<a href="reminder.jsp"><bean:message key="label.staffEducation" /></a> -> <bean:message key="function.staffEducation.education.nchk" />
			</div>
			<h2><bean:message key="label.staffEducation" /></h2>
			<h3><bean:message key="function.staffEducation.education.nchk" /></h3>
