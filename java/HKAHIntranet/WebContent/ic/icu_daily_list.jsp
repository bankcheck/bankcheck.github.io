...
request.setAttribute("progress", ICIcuDailyDB.getList(labNo, FromDateIn, ToDateIn ));
...
<form name="form1" action="icu_daily.jsp" method="post">
<%	if (!createAction && !updateAction) {%>
<bean:define id="functionLabel"><bean:message key="function.ic.icu_daily.list" /></bean:define>
