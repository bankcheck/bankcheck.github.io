...
String patmstsOther = request.getParameter("patmstsOther");
...
if (HttpFileUpload.isMultipartContent(request)){
	...
	patmstsOther = (String) request.getAttribute("patmstsOther");
	...
	roomType = (String) request.getAttribute("roomType");
		...
		<td>
			<table class="person-info-tab" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td height="20" valign="top"><%=regligionDesc==null?"":("Others".equals(regligionDesc)?religionOther:regligionDesc) %></td>
					<td width="002">&nbsp;</td>
				...
				<tr>
					...
					<td height="20" valign="top"><%=edulevel==null?"":("Others".equals(edulevel)?"":edulevel) %></td>
					<td width="002">&nbsp;</td>
				...
				<tr>
					...
					<td height="20" valign="top" colspan="4"><%=patadd1==null?"":patadd1 %> <%=patadd2==null?"":patadd2 %> <%=patadd3==null?"":patadd3 %> <%=coucode==null||"".equals(coucode) ?"":AdmissionDB.getCountryDesc(coucode) %></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td height="20" valign="top"><%=admissiondoctor==null?"":(AdmissionDB.getDocName(admissiondoctor)==null?admissiondoctor:AdmissionDB.getDocName(admissiondoctor)) %></td>
					<td width="002">&nbsp;</td>
							...
							<tr>
								<td>
									<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
										...
										<tr>
											<td width="20" valign="top">1.</td><td>All information given by me to the Hong Kong Adventist Hospital ('the Hospital') is true and correct to the best of my knowledge;</td>
										</tr>
										<tr>
											<td width="20" valign="top">2.</td><td>I acknowledge receipt of "Healthcare Advisory", "Daily Room Rate", "Advance Payment", "Patient Admission", and "Patients' Charter" from the Hospital, which I have read, understand and hereby agree to all terms and conditions therein;</td>
										</tr>
										<tr>
											<td width="20" valign="top">3.</td><td>I agree to pay the Hospital the rates and charges (including but not limited to Out-patient and incidental charges ) stipulated by the Hospital for all goods and services rendered to me by the Hospital during my hospitalization;</td>
										</tr>
										<tr>
											<td width="20" valign="top">4.</td><td>I hereby authorize the Hospital to release / disclose / share my personal data by post or email with address provided by me.  I understand it is my responsibility to provide the Hospital my updated address for such purpose. I further authorize the Hospital to contact and release / disclose / share my relevant personal data (including but not limited to medical record) to / with my insurer, its agent or broker for activities pertaining to my insurance claim, or any accreditation institutions / organizations / company involved in accreditation of the Hospital, or government units of  Hong Kong Special Administrative Region for  descriptive studies, statistic data collections, analyses, regulations compliance, health services planning and healthcare evaluation;</td>
										</tr>
										<tr>
											<td width="20" valign="top">5.</td><td>I agree to pay any outstanding charges that have not been paid or covered by my insurer;</td>
										</tr>
										<tr>
											<td width="20" valign="top">6.</td><td>I understand that the Hospital serves vegetarian meals only;</td>
										</tr>
										<tr>
											<td width="20" valign="top">7.</td><td>I agree to comply with the Hospital policy during my hospitalization, e.g. solely using medications and tube feeding formula provided by the Hospital;</td>
										</tr>
										<tr>
											<td width="20" valign="top">8.</td>
											<td>I give my consent herein to the Hospital to send its direct marketing and health promotion materials in relation to its services to me by post, SMS, fax,
											    electronic mail or other means of communication or making telephone calls via my address, telephone numbers, fax number and email address provided by me to the Hospital.
											...
											<br/><br/>I understand that I may at any time require and notify the Hospital to cease to use my data in direct marketing of health services and promotion and the Hospital must,
											 without charge to me, comply with the requirement.  The notification of such requirement may be sent to the Hospital by post,
											 electronic mail, telephone call or other means of communication. (Telephone No：3651 8997; Email Address：patientservice@hkah.org.hk)
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="20" valign="top">1.</td><td>本人提供予香港港安醫院（「醫院」）的所有資料，在本人的個人認知範圍內，皆屬實和正確；</td>
										</tr>
										<tr>
											<td width="20" valign="top">2.</td><td>本人確認已收到及仔細閱讀〈住院須知〉、〈每日房租〉、〈預繳按金〉、〈入院須知〉和〈病人權益與責任〉等文件，並且明白及同意上述文件的一切條款；</td>
										</tr>
										<tr>
											<td width="20" valign="top">3.</td><td>本人同意支付所有在住院期間由醫院提供予本人的物品和服務的規定費用（包括但不限於門診或偶發事故所需費用）</td>
										</tr>
										<tr>
											<td width="20" valign="top">4.</td><td>本人在此授權醫院可以郵寄或電子方式，提交 / 透露 / 分享本人的個人資料予由本人所提
																						供的地址或電郵地址。本人亦明白有責任向醫院提供最新的地址或電郵地址以達到這目的。
																						本人同時授權醫院就本人的保險索償事宜與本人的承保人、代理人或經紀人聯繫，及向其提
																						交 / 透露 / 分享或索取本人有關的個人資料（包括但不限於醫療記錄），及授權醫院提交
																						/ 透露 / 分享與本人有關的個人資料（包括但不限於醫療記錄）予任何參與評審醫院認證
																						的認可機構 / 組織 / 公司，或香港特別行政區政府單位作描述性研究、收集統計數據、分
																						析、法規遵從、健康服務規劃和衞生保健評估的用途；</td>
										</tr>
										<tr>
											<td width="20" valign="top">5.</td><td>本人同意支付所有尚未繳付或保險公司未能承保的額外費用；</td>
										</tr>
										<tr>
											<td width="20" valign="top">6.</td><td>本人明白醫院膳食部只供應素食餐膳；</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="20" valign="top">8.</td>
											<td>本人同意醫院可以藉郵件、短訊、圖文傳真、電子郵件或其他形式的傳訊，或通過電話通話，向本人提供與醫院服務或健康訊息有關的資料。
											<br/><br/><%=infoForPromotion!=null&&infoForPromotion.equals("N")?"☑":"□"%> 本人不同意醫院使用本人的個人資料來提供與醫院服務或健康訊息有關的資料。
											<br/><br/>本人明白，本人可以隨時藉郵件、電子郵件、電話通話或其他形式的傳訊，通知醫院停止使用本人的個人資料來提供與醫院服務或健康訊息有關的資料。同時，醫院不會因此向本人收取費用。(電話號碼：3651 8997; 電郵地址：patientservice@hkah.org.hk)
											</td>
										</tr>
										<tr>
											<td height="2" colspan="2">&nbsp;</td>
										...
										<tr>
											<td colspan="2">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														<td style="font-size:80%;" colspan="3">(Age 18 or above 十八歲或以上)</td>
													</tr>
													<tr>
														<td height="2">&nbsp;</td>
													</tr>
...
<table width="800" border="0" cellpadding="0" cellspacing="0">
	...
	<td valign="top" align="left" width="95%"> By checking this box, I confirm that I have read, understood and agreed the Patient's Agreement and the <a class="topstoryblue" onclick=" downloadFile('632', ''); return false;" href="javascript:void(0);" target="_blank">Policy Statement relating to the Personal Data (Privacy) Ordinance</a>.</br>
											          本人已閱讀及同意病人恊議及關於<a class="topstoryblue" onclick=" downloadFile('767', ''); return false;" href="javascript:void(0);" target="_blank">《個人資料 (私隱) 條例》("私隱條例") 的政策指引</a>。
	<p><span">&nbsp;</span></p>
	</td>
	</tr>
	<tr>
