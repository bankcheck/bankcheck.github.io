					...
					<tr>
						...
						<tr>
							<td class="enquiryLabel extraBigText">
								<p align ="left" style="font-size:120% ; color:gray"><b><%=MessageResources.getMessage(locale, "adm.cash.notes") %></b></p>
								<p align ="left" style="font-size:80% ; color:gray">
									<br/>
									<%=MessageResources.getMessage(locale, "adm.cash.note.line1") %>
									<br/><br/>
								</p>
								<br>
							</td>
			...
			<tr>
				<td class="middleText">
					<p align="left">
						...
						<button onclick="javascript:window.location.href = 'online_admission_submit.jsp?language=<%=language%>&paymentType=UPON_ARRIVAL&admissionID=<%=admissionID %>'"><%=MessageResources.getMessage(locale, "button.page.next") %></button>
					</p>
				</td>
			</tr>					
		</table>
