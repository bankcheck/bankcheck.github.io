...
if (patidno != null && patidno.length() > 0) {
	...
	record = AdmissionDB.getHATSPatientList(patno, pattraveldoc, pathtel, patbdate, patSex, patFName==null?"":patFName.toUpperCase(), patGName==null?"":patGName.toUpperCase(), patMName==null?"":patMName.toUpperCase(),patmtel,patemail);
}
