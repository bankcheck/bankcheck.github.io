...
<%!
	private ArrayList fetchStaff() {
		...
		sqlStr.append("SELECT DISTINCT S.CO_STAFF_ID,S.CO_LASTNAME,S.CO_FIRSTNAME ");
		sqlStr.append("FROM CRM_GROUP C,CO_STAFFS S ");
		sqlStr.append("WHERE C.CRM_GROUP_CASE_MANAGER = S.CO_STAFF_ID ");
...
if (isFilterValues) {
	filterValues = (String[]) request.getAttribute("clientGroupCaseManagerCMB_filterValues");
}
