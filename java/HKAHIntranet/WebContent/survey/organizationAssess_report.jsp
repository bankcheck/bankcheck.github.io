...
// constant
String documentID = "404";	//String documentID = "400";
String sheetName = "Assessment";
...
qidAidToColIndex.put("1-*", 1);
qidAidToColIndex.put("2-*", 2);
qidAidToColIndex.put("3-*", 3);
qidAidToColIndex.put("4-*", 4);
qidAidToColIndex.put("5-*", 5);
qidAidToColIndex.put("6-*", 6);
qidAidToColIndex.put("7-*", 7);
qidAidToColIndex.put("7-3", -1);
qidAidToColIndex.put("8-*-1", 8);
qidAidToColIndex.put("8-*-2", 9);
qidAidToColIndex.put("8-*-3", 10);
qidAidToColIndex.put("8-10", -1);
qidAidToColIndex.put("9-*-1", 11);
qidAidToColIndex.put("9-*-2", 12);
qidAidToColIndex.put("9-*-3", 13);
qidAidToColIndex.put("9-8", -1);
qidAidToColIndex.put("10-*-1", 14);
qidAidToColIndex.put("10-*-2", 15);
qidAidToColIndex.put("10-*-3", 16);
qidAidToColIndex.put("10-7", -1);
qidAidToColIndex.put("11-*", 17);
qidAidToColIndex.put("12-*", 18);
qidAidToColIndex.put("13-*", 19);
qidAidToColIndex.put("14-*", 20);
qidAidToColIndex.put("14-6", -1);
qidAidToColIndex.put("15-*", 21);
qidAidToColIndex.put("16-*", 22);
qidAidToColIndex.put("17-*", 23);
qidAidToColIndex.put("18-*", 24);
qidAidToColIndex.put("19-*", 25);
qidAidToColIndex.put("20-*", 26);
qidAidToColIndex.put("21-*", 27);
qidAidToColIndex.put("22-*", 28);

List<String> appendAnsDesc = new ArrayList<String>();
appendAnsDesc.add("8-10");
appendAnsDesc.add("9-8");
appendAnsDesc.add("10-7");
...
SA.EE_ENROLL_ID, SA.EE_EVALUATION_QID, SA.EE_EVALUATION_AID, A.EE_ANSWER, SA.EE_USER_TYPE, SA.EE_USER_ID, SA.EE_EVALUATION_SITE, SA.EE_EVALUATION_ANSWER_DESC, A.EE_ISFREETEXT ");
		    ...
		    */
		    ...
		    response.setHeader("Content-Disposition", "attachment; filename=HKAH Alignment Assessement Survey Report (User Type "+userCat+").xlsx");
