...
<table cellpadding="0" cellspacing="5"
	...
	<tr class="smallText">
		...
		<td class="infoData" width="70%"><html:password property="oldPassword" value="" size="20"/></td>
	</tr>
	<tr class="smallText">
		<td class="infoLabel" width="30%"><bean:message key="prompt.new.password" /></td>
		<td class="infoData" width="70%"><html:password property="password" value="" size="20"/></td>
	</tr>
	<tr class="smallText">
		<td class="infoLabel" width="30%"><bean:message key="prompt.confirm.password" /></td>
		<td class="infoData" width="70%"><html:password property="confirmPassword" value="" size="20"/></td>
	</tr>
</table>
...
<script language="javascript">
	...
	$("#ChangePasswordForm").validate({
		...
		rules: {
			...
			confirmPassword: { required: true, minlength: 1 }
		},
		messages: {
			oldPassword: {
