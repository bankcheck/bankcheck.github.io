...
<%
	...
	if ("1".equals(run)) {
		...
		sqlStr.append("SELECT V.STAFF_CODE, V.SURNAME, V.GIVEN_NAME, V.CHRISTIAN_NAME, " +
				"V.DATE_JOINED, V.DEPT_CODE, V.EMAIL_ADDRESS, V.JOB_DESCRIPTION, V.STAFF_STATUS, V.SITE, V2.DEPT_DESCRIPTION, V.JOB_DESCRIPTION, V.JOB_CODE, V.TYPE_CODE ");
...
<%
        		   for (int i = 0; i < result.size(); i++) {
						...
						jobCode = TextUtil.parseStr(rlo.getValue(12));
						typeCode = TextUtil.parseStr(rlo.getValue(13));
