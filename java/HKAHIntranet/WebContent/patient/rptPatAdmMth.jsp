...
if("view".equals(command)){
	ArrayList AdmRecord = PatientDB.getPatientAdmissionReport(reportMth1);

	if(AdmRecord.size()>0){
		reportFile = new File(application.getRealPath("/report/RPT_PAT_ADM_MTH.jasper"));
		...
		if (reportFile != null && reportFile.exists()) {
			...
			JasperPrint jasperPrint =
				JasperFillManager.fillReport(
					jasperReport,
					parameters,
					new ReportMapDataSource(AdmRecord, new String[]{"WRDCODE","TIME_SLOT","COL1","COL2","COL3",
			...
			response.setHeader("Content-Disposition", "attachment;filename=PatientAdmissionReport_" + tsFormat.format(new Date()) + ".xls");
		...
		<div id=indexWrapper>
			<div id=mainFrame>
				<jsp:include page="../common/page_title.jsp" flush="false">
					<jsp:param name="pageTitle" value="function.patAdm.report" />
				...
				<form name="searchPbForm" action="rptPatAdmMth.jsp" method="get">
