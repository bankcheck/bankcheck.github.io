...
if("view".equals(command)){
	ArrayList RehabRecord = PatientDB.getPatientRehabStat(reportMth1);

	if(RehabRecord.size()>0){
		reportFile = new File(application.getRealPath("/report/RPT_PAT_REHAB_MTH.jasper"));
		...
		if (reportFile != null && reportFile.exists()) {
			...
			JasperPrint jasperPrint =
				JasperFillManager.fillReport(
					jasperReport,
					parameters,
					new ReportMapDataSource(RehabRecord, new String[]{"TIME_SLOT","COL1","COL2","COL3",
			...
			response.setHeader("Content-Disposition", "attachment;filename=PatientRehabStatTimeSlot_" + tsFormat.format(new Date()) + ".xls");
		...
		<div id=indexWrapper>
			<div id=mainFrame>
				<jsp:include page="../common/page_title.jsp" flush="false">
					<jsp:param name="pageTitle" value="function.patRehab2.report" />
				...
				<form name="searchPbForm" action="rptPatRehabMth.jsp" method="get">
