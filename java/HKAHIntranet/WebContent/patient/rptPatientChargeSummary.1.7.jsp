...
if("view".equals(command)){
	...
	*/
	...
	reportFile = new File(application.getRealPath("/report/RPT_PAT_CHARGE_SUMMARY.1.7.jasper"));
		...
		<div id=indexWrapper>
			<div id=mainFrame>
				<jsp:include page="../common/page_title.jsp" flush="false">
					<jsp:param name="pageTitle" value="function.rptPatientChargeSummary.report.1.7" />
				...
				<form name="rptPatientChargeSummaryForm" action="rptPatientChargeSummary.1.7.jsp" method="get">
