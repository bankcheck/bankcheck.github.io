...
if("view".equals(command)){
	ArrayList TreatmentRecord = PatientDB.getPatTreatByItem(stnCDateFrom, stnCDateTo);

	if(TreatmentRecord.size()>0){
		reportFile = new File(application.getRealPath("/report/RptTreatByItem.jasper"));
		...
		if (reportFile != null && reportFile.exists()) {
			...
			JasperPrint jasperPrint =
				JasperFillManager.fillReport(
					jasperReport,
					parameters,
					new ReportMapDataSource(TreatmentRecord, new String[]{"ITMCODE","ITMNAME","COUNT_TREAT"},
					null));	
			...
			response.setHeader("Content-Disposition", "attachment;filename=TreatmentBreakdownByItem_" + tsFormat.format(new Date()) + ".xls");
		...
		<div id=indexWrapper>
			<div id=mainFrame>
				<jsp:include page="../common/page_title.jsp" flush="false">
					<jsp:param name="pageTitle" value="function.treatmentBrkDwnByItem.report" />
				...
				<form name="searchPbForm" action="rptTreatByItem.jsp" method="get">
