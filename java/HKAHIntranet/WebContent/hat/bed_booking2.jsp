...
/*======== Description of this page ===========
  ...
  Log: 20090702, ck. first release; 20100806, call CIS_ISVALID_BAD(), ck.
================================================ */
  
//======== connect to database ===========
String sql, sysdate="";
String[][] bedlist = new String [500][6];
String[][] booking = new String [500][6];
String[][] notshow = new String [500][6];
...
sql += "     , b.wrdcode, b.romcode, b.beddesc as bedinfo, i.patno, nvl(patsex,vb) as gender ";
sql += "     , to_char(sysdate,'dd-mm-yyyy hh24:mi:ss')  ";
sql += " from (select r.acmcode, r.wrdcode, b.romcode, b.bedcode, b.beddesc, r.romsex, bedremark, cis_isvalid_bed(b.bedcode) as vb ";
...
String acm = "x", bedStr;
String[][] bedList = new String [6][9];
String[][] bkList = new String [6][9];
...
for (i=0; i<bCnt; i++ ) {
  ...
  bedBkg[0]++;
  bedStr = booking[i][4] + ": " + booking[i][5] + "<BR>";
...
<table align=center width=98% border=1 cellpadding="0" cellspacing="0">
  <tr>
   ...
   <th width=14%>&nbsp;OB <br><table width=100%><tr><td><td align=right>Booking Cases </table></th>
   <th width=14%>&nbsp;Surgical<br><table width=100%><tr><td><td align=right>Booking Cases </table></th>
   <th width=14%>&nbsp;Pediatric Unit<br><table width=100%><tr><td><td align=right>Booking Cases </table></th>
   <th width=14%>&nbsp;Medical Unit<br><table width=100%><tr><td><td align=right>Booking Cases </table></th> 
   <TH width=14%>&nbsp;Integrated Unit<br><table width=100%><tr><td><td align=right>Booking Cases </table></th>
   <TH width=14%>&nbsp;ICU<table width=100%><tr><td><td align=right>Booking Cases </table></th>
  </tr>

<%
//========= show table =============
String TDcode1 = "<td><table width=100% height=100% border=0><tr><td valign=top width='40%'><font color=green>";
...
for (i=0; i<=m; i++) {
    ...
    out.println(TDcode2 + bkList[i][6] + "</td></tr></table> </td></tr>");
}
...
out.println( "<br>&nbsp;" + pctFormat.format(1.00*(bedCnt[6]-bedFre[6]+bedBkg[6])/bedCnt[6])+ " Bed Occupied</td></tr>" );
