...
/*======== Description of this file =============================
  Log: 20091113,20091224, ck. Common Census Report For Table MIS_COUNT
       2010/9/21, ck, using YTM change instead of month-cnt
================================================================ */
...
sql += " where cnt_group='" + cntGroup + "' and cnt_name='" + cntName + "' order by 1 desc ";
rs  = stmt.executeQuery(sql);
    ...
    <table align=center width=90% border=1 cellpadding="0" cellspacing="0">
      <tr>
       ...
       <th width=180>&nbsp;<%=prevYear%><br>
           <table width=90% border=0><tr><td align=center>Count<td align=right>YTM</tr></table></th>
       <th width=180>&nbsp;<%=thisYear%><br>
           <table width=90% border=0><tr><td align=center>Count<td align=right>YTM</tr></table></th>
       <th width=180>Changes Compare<br>with Prev Month</th>
       <th width=180>YTM Change<br>
           <table width=90% border=0><tr><td align=center>Count<td align=right>%</tr></table></th>
      </tr>

<%

//========== get op cnt for prev month =========
sql = " select sum(cnt_num1) as cnt from mis_count ";
...
sql += "            , sum(cnt_num1) as cnt, max(create_date) as upddate  ";
sql += "       from mis_count ";
sql += "       where cnt_group='"+cntGroup+"' and cnt_name='"+cntName+"' ";
...
while (rs.next()) {
   ...
   if ( curYear.compareTo(thisYear)==0 && curMonth.compareTo(thisMth)==0 ) {
      ...
      out.println( "<td><table width=90% align=center border=0><tr>");
      out.println( "  <td width=50% align=right>"+cntVal2+"*</td>");
      out.println( "  <td width=50% align=right>&nbsp</tr></table></td>" );
...
out.println( (acc2-acc1)+"</td><td  width=50% align=right>"+pctFormat.format(1.00*(acc2-acc1)/acc1) );
