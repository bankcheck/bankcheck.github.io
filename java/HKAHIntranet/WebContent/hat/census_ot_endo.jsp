...
// ======list of year ============
sql = " select distinct to_char(otldate,'yyyy') from ot_log@hat a, ot_proc@hat p";
sql += "  where a.otpid=p.otpid and otlsts<>'X' and p.otpcode like 'EU%' ";
...
<!-- right area, data -->
  <td><br>
    <p align=center>
       ...
       <b>Operating Room Procedure Census (Endoscopy Only)</b></font>
    </p>
...
sql = " select count(*) as cnt from ot_log@hat a, ot_proc@hat p";
sql += "  where a.otpid=p.otpid and otlsts<>'X' and p.otpcode like 'EU%' ";
...
sql += "            , count(*) as cnt  ";
sql += "         from ot_log@hat a, ot_proc@hat p  ";
sql += "        where a.otpid=p.otpid and p.otpcode like 'EU%' and otlsts<>'X' ";
