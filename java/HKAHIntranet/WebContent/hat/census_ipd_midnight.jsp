...
<title>Inpatient Hospital Days (Midnight)</title>
<body bgcolor=#F9F3F6>
...
<!-- right area, data -->
  <td><br>
    <p align=center>
       <font style="font-size:16px;font-weight:bold;color:darblue"><b>Inpatient Hospital Days (Midnight)</b></font>
    </p>
...
sql = " select sum(cnt_midnight) as cnt from mis_bedcnt  ";
