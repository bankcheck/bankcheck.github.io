...
<form name="search_form" action="monthly_ob_report.jsp" method="post">
...
<%=parseTable(arrayList2HashMapInString(recordYear1, 1)) %>
	...
	<tr>
		<td align="center">No. of booking created (Normal/Registered)</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 2), arrayList2HashMapInString(recordYear1, 3)) %>
	</tr>
	<tr>
		<td class="infoCenterLabel" colspan="13">Waiting List</td>
	</tr>
	<tr>
		<td align="center">Local/Expatriate Parents (<font color="blue">Waiting</font>)</td>
<%=parseTable(arrayList2HashMapInString(recordYear1_waiting, 2)) %>
	</tr>
	<tr>
		<td align="center">Mainland Mother + Local/Expatriate Father (<font color="blue">Waiting</font>)</td>
<%=parseTable(arrayList2HashMapInString(recordYear1_waiting, 3)) %>
	</tr>
	<tr>
		<td align="center">Mainland Parents (<font color="blue">Waiting</font>)</td>
<%=parseTable(arrayList2HashMapInString(recordYear1_waiting, 4)) %>
	</tr>
	<tr>
		<td class="infoCenterLabel" colspan="13">Booking List</td>
	</tr>
	<tr>
		<td align="center">Local/Expatriate Parents (<font color="green">Booking</font>) ( <a href="monthly_ob_report_china.jsp?type=L&edcYear=<%=searchYear%>">Detail</a> )</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 6)) %>
	</tr>
	<tr>
		<td align="center">Mainland Mother + Local/Expatriate Father (<font color="green">Booking</font>) ( <a href="monthly_ob_report_china.jsp?type=S&edcYear=<%=searchYear%>">Detail</a> )</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 7)) %>
	</tr>
	<tr>
		<td align="center">Mainland Parents (<font color="green">Booking</font>) ( <a href="monthly_ob_report_china.jsp?type=B&edcYear=<%=searchYear%>">Detail</a> )</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 8)) %>
	</tr>
	<tr class="warning">
...
<%=parseTable(arrayList2HashMapInString(recordYear1_actual, 3)) %>
	...
	<tr>
		<td align="center">Mainland Parents (Actual)</td>
<%=parseTable(arrayList2HashMapInString(recordYear1_actual, 4)) %>
	</tr>
	<tr class="warning">
...
<%=parseTableWithPercentage(noOfActualDeliveryYear1, noOfActualDeliveryYear2) %>
	...
	<tr>
		<td align="center">No. of deposit paid<br/>YTM</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 4)) %>
	</tr>
	<tr>
		<td align="center">No. of staff(no need deposit)<br/>YTM</td>
<%=parseTable(arrayList2HashMapInString(recordYear1, 5)) %>
	</tr>
</table>
...
<table border="1" width="100%">
	<tr>
		<td class="infoCenterLabel" width="20%"><%=prevSearchYear %></td>
		<td class="infoCenterLabel" width="05%">Jan</td>
		<td class="infoCenterLabel" width="05%">Feb</td>
		<td class="infoCenterLabel" width="05%">Mar</td>
		<td class="infoCenterLabel" width="05%">Apr</td>
	...
	<tr>
		<td align="center" width="20%">No. of booking created<br/>YTM</td>
<%=parseTable(arrayList2HashMapInString(recordYear2, 1)) %>
	</tr>
	<tr class="warning">
		<td align="center" width="20%">No. of actual delivery<br/>YTM</td>
<%=parseTable(noOfActualDeliveryYear2) %>
	</tr>
	<tr>
		<td align="center" width="20%">No. of deposit paid<br/>YTM</td>
<%=parseTable(arrayList2HashMapInString(recordYear2, 4)) %>
	</tr>
	<tr>
		<td align="center" width="20%">No. of staff(no need deposit)<br/>YTM</td>
<%=parseTable(arrayList2HashMapInString(recordYear2, 5)) %>
	</tr>
</table>
<span id="previous_report_result"></span>
</DIV>
	...
	function processResponse() {
		...
		if (http.readyState == 4){
			...
			if (div_indicator == 'current_report_result') {
				var docCode = document.forms["search_form"].elements["docCode"].value;
				submitSearchHelper(docCode, selectedPreviousYear, "previous_report_result");
			}
		}
	}
