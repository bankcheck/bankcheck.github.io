...
SELECT A.PATNO, SLPNO, REGID, 'TWAH' AS PATTYPE, PATFNAME, PATGNAME
from twah.slip@IWEB a, patient@IWEB b
...
FROM twah.SLIP@IWEB A WHERE a.SLPSID=0 AND PATNO IS NULL;
