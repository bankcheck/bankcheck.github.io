...
#Import selenium service in case chromedriver does not work in the testing environment
...
#function login parameters username, password, and the complete path for the output screenshot file
def login(pUsername, pPassword, pFilename):

    #Define the chrome driver
    driver = webdriver.Chrome('C:\Drivers\chromedriver')
    #Uncommend the code below in case the Chromedriver does not work in the testing environment
...
#Construct the output screenshot filename using the current py file path and the choice
