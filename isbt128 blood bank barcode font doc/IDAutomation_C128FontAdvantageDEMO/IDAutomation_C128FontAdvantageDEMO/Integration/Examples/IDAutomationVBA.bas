...
'*****************************************************************
'  VB & VBA Functions for IDAutomation Barcode Fonts 2020
'  © Copyright, 2000-2020 IDAutomation.com, Inc. All rights reserved.
'
...
Public Function IDAutomation_C128HR(DataToFormat As String, _
                                    Optional ReturnImage As Integer = 0, _
                                    Optional ApplyTilde As Boolean = True, _
                                    Optional SingleLineHR As Boolean = True)
  ...
  Dim intAI As Integer
  Dim AILenCode As Integer
  Dim AILenString As Integer
  Dim bnlSkip As Boolean
  ...
  'Check for null data
  If IsNull(DataToFormat) Or DataToFormat = "" Then
    IDAutomation_C128HR = ""
    Exit Function
  End If
  ...
  If (CurrentCharNum = 202) Or ((CurrentCharNum > 211) And (CurrentCharNum < 219)) Then
    ...
    Do While i <= L
      ...
      If ((CurrentCharNum > 211) And (CurrentCharNum < 219)) Then
        AILenCode = CurrentCharNum - 210
        intAI = Mid(DataToFormat, i + 1, AILenCode)
        i = i + 1
      
      ElseIf (CurrentCharNum = 202) Then
        i = i + 1
        bnlSkip = True
        bFlag = True
      ElseIf bFlag And (CurrentCharNum >= AscW("0") And CurrentCharNum <= AscW("9")) Then
        intAI = Val(Mid(DataToFormat, i, 2))
        If (intAI >= 0 And intAI <= 21) Or (intAI = 30) Or (intAI = 37) Or (intAI >= 90 And intAI <= 99) Then
          AILenCode = 2
        ElseIf (intAI >= 24 And intAI <= 25) Or (intAI >= 40 And intAI <= 42) Or (intAI = 71) Then
          intAI = Val(Mid(DataToFormat, i, 3))
          AILenCode = 3
        ElseIf (intAI >= 31 And intAI <= 36) Or (intAI = 39) Then
          intAI = Val(Mid(DataToFormat, i, 3))
          AILenCode = 4
        ElseIf (intAI = 70) Or (intAI = 80) Or (intAI = 81) Then
          intAI = Val(Mid(DataToFormat, i, 4))
          AILenCode = 4
        End If
      End If
      
      If (Not bnlSkip) And AILenCode > 0 Then
        If (SingleLineHR Or HRString = "") Then
           HRString = HRString & "(" & (Mid(DataToFormat, i, AILenCode)) & ") "
        Else
           HRString = HRString & vbCrLf & "(" & (Mid(DataToFormat, i, AILenCode)) & ") "
        End If
        
        If intAI = 0 Or intAI = 8017 Or intAI = 8018 Then
          AILenString = 18
        '2016R2 Update for future AI 03
        ElseIf intAI = 1 Or intAI = 2 Or intAI = 3 Or intAI = 8001 Then
            AILenString = 14
        '2016R2 Update for future AI 04
        ElseIf intAI = 4 Then
            AILenString = 16
        ElseIf intAI = 10 Or intAI = 21 Or intAI = 243 Or intAI = 254 Or intAI = 420 Or _
               (intAI >= 710 And intAI <= 713) Or intAI = 8002 Or intAI = 8012 Then
          numAlpha = 20
        '2016R2 Update for future AI 14, 18 & 19
        ElseIf (intAI >= 11 And intAI <= 19) Or (intAI >= 3100 And intAI <= 3949) Or intAI = 8005 Then
          AILenString = 6
        ElseIf intAI = 20 Then
          AILenString = 2
        ElseIf intAI = 240 Or intAI = 241 Or intAI = 250 Or intAI = 251 Or _
               intAI = 400 Or intAI = 401 Or intAI = 403 Or _
               intAI = 8004 Or intAI = 8010 Or (intAI >= 90 And intAI <= 99) Then
          numAlpha = 30
        ElseIf intAI = 242 Then
          numNum = 6
        ElseIf intAI = 253 Then
          AILenString = 13
          numAlpha = 17
        ElseIf intAI = 255 Then
          AILenString = 13
          numNum = 12
        ElseIf intAI = 30 Then
          numNum = 8
        ElseIf intAI = 402 Then
          AILenString = 17
        ElseIf (intAI >= 410 And intAI <= 415) Then
          AILenString = 13
        ElseIf intAI = 421 Then
          AILenString = 3
          numAlpha = 9
        ElseIf intAI = 422 Or intAI = 424 Or intAI = 425 Or intAI = 426 Then
          AILenString = 3
        ElseIf intAI = 423 Then
          AILenString = 3
          numNum = 12
        ElseIf intAI = 427 Then
          numAlpha = 3
        ElseIf intAI = 7001 Then
          AILenString = 13
        ElseIf intAI = 7003 Then
          AILenString = 10
        ElseIf intAI = 7004 Then
          numNum = 4
        ElseIf intAI = 7005 Then
          numAlpha = 12
        ElseIf intAI = 7006 Then
          AILenString = 6
        ElseIf intAI = 7007 Then
          AILenString = 6
          numNum = 6
        ElseIf intAI = 7008 Then
          numAlpha = 3
        ElseIf intAI = 7009 Then
          numAlpha = 10
        ElseIf intAI = 7010 Then
          numAlpha = 2
        ElseIf intAI >= 7030 And intAI <= 7039 Then
          AILenString = 3
          numAlpha = 27
        ElseIf intAI = 8003 Then
          AILenString = 14
          numAlpha = 16
        ElseIf intAI = 8006 Then
          AILenString = 18
        ElseIf intAI = 8007 Then
          numAlpha = 34
        ElseIf intAI = 8008 Then
          AILenString = 8
          numNum = 4
        ElseIf intAI = 8011 Then
          numNum = 12
        ElseIf intAI = 8019 Then
          numNum = 10
        ElseIf intAI = 8020 Then
          numAlpha = 25
        ElseIf intAI = 8110 Or intAI = 8200 Then
          numAlpha = 70
        ElseIf intAI = 8111 Then
          AILenString = 4
        End If
        
        If numNum > 0 Then
          For j = 1 To numNum
             If ((i + AILenCode + AILenString) > L) Then Exit For
             Temp = AscW(Mid(DataToFormat, i + AILenCode + AILenString, 1))
             If Temp < 48 Or Temp > 57 Then Exit For
             AILenString = AILenString + 1
          Next
        End If
        ...
        If numAlpha > 0 Then
          For j = 1 To numAlpha
             If ((i + AILenCode + AILenString) > L) Then Exit For
             Temp = AscW(Mid(DataToFormat, i + AILenCode + AILenString, 1))
             If Temp < 33 Or Temp > 122 Then Exit For
             AILenString = AILenString + 1
          Next
        End If
        
        If (i + AILenCode + AILenString - 1) > L Then AILenString = L - (i + AILenCode) + 1
        If AILenString > 0 Then
          HRString = HRString & Mid(DataToFormat, i + AILenCode, AILenString)
        End If
        i = i + AILenCode + AILenString
        bFlag = (AILenString > 0)
      End If
      
      If (Not bnlSkip) And AILenCode = 0 Then
      
        If (AscW(Mid(DataToFormat, i, 1)) = 197) Or (AscW(Mid(DataToFormat, i, 1)) < 32) Then
          HRString = HRString & " "
        ElseIf ((AscW(Mid(DataToFormat, i, 1)) > 31) And (AscW(Mid(DataToFormat, i, 1)) < 128)) Then
          HRString = HRString & Mid(DataToFormat, i, 1)
        End If
        i = i + 1
    ...
    Loop
    IDAutomation_C128HR = HRString
  Else
    IDAutomation_C128HR = DataToFormat
  End If
End Function
...
Public Function Code128a(DataToEncode As String, Optional ReturnType As Integer = 0) As String
     'This method has been updated to support ReturnTypes 6 to 9,
     'which increases its complexity. IDAutomation suggests using
     'the prior version (http://www.idautomation.com/fonts/tools/barcodeapp/module1.txt)
     'of this code when performing conversions or modifications.
...
Public Function Code128b(DataToEncode As String, Optional ReturnType As Integer = 0) As String
     'This method has been updated to support ReturnTypes 6 to 9,
     'which increases its complexity. IDAutomation suggests using
     'the prior version (http://www.idautomation.com/fonts/tools/barcodeapp/module1.txt)
     'of this code when performing conversions or modifications.
...
Public Function Code39Mod43(DataToEncode As String, Optional ReturnType As Integer = 0) As String
    ...
    For i = 1 To StringLength
        ...
        'Space
        If CurrentCharNum = 32 Then OnlyCorrectData = OnlyCorrectData & "_"
        '-
    ...
    'Space
    If CheckDigitValue = 38 Then CheckDigit = 95
    '-
...
Public Function I2of5Mod10(DataToEncode As String, Optional ReturnType As Integer = 0) As String
...
Public Function MSI(DataToEncode As String, Optional ReturnType As Integer = 0) As String
...
Public Function IDAEAN13(DataToEncode As String) As String
...
Public Function IDAEAN8(DataToEncode As String) As String
...
Public Function GS1_128(GS1ToEncode As String) As String
    'Check for FNC1 which can be ASCII 202 and ASCII 212-217
    CurrentCharNum = AscW(Mid(GS1ToEncode, 1, 1))
    If ((CurrentCharNum = 202) Or ((CurrentCharNum > 211) And (CurrentCharNum < 219))) Then
        'do nothing, AI is already in the data
    Else
        GS1ToEncode = ChrW(202) & GS1ToEncode
    End If
    GS1_128 = Code128(GS1ToEncode, 0, True)
End Function
...
Public Function Postnet(DataToEncode As String, Optional ReturnType As Integer = 0) As String
...
Public Function SpliceText(DataToFormat As String, Optional SpacingNumber As Integer = 4, Optional ApplyTilde As Boolean = False) As String
