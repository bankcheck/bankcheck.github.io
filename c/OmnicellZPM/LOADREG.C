...
int LoadRegVal(void)
{
	...
	sprintf(szFile, "%s%sOMNICELL.ini", drive, dir);
	...
	GetPrivateProfileString(MY_PROFILE, "LogPath",
                            "C:\\HL7\\OMNICELL\\LOG.ZPM\\", g_szLogPath, 260, szFile);
    AddBslash(g_szLogPath);
/*    
	GetPrivateProfileString(MY_PROFILE, "InBoxPath",
                            "C:\\HL7\\OMNICELL\\INBOX\\", g_szInBoxPath, 260, szFile);
...
*/
	GetPrivateProfileString(MY_PROFILE, "OutBoxPath",
                            "C:\\HL7\\OMNICELL\\OUTBOX\\", g_szOutBoxPath, 260, szFile);
    AddBslash(g_szOutBoxPath);

    GetPrivateProfileString(MY_PROFILE, "TempPath",
                            "C:\\MOXA\\OMNICELL\\TEMP\\", g_szTempPath, 260, szFile);
