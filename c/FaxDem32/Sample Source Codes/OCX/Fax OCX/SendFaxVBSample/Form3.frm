...
Private Sub CommandOK_Click()
    ...
    If Len(Form1.FAX1.ClassType) <> 0 Then
        ...
        Else
            ...
            Form1.FAX1.SetPortCapability COMList.List(COMList.ListIndex), PC_ECM, EC_ENABLE
            Form1.FAX1.SetPortCapability COMList.List(COMList.ListIndex), PC_MAX_BAUD_SEND, BR_33600
        End If
    Else
