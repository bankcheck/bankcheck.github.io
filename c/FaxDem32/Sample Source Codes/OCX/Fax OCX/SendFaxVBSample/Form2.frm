...
Private Sub CommandOK_Click()
    ...
    If PageNum > 0 Then
        FaxID = Form1.FAX1.CreateFaxObject(1, PageNum, 3, 2, 1, 2, 2, 1, 2, 1)
        If (FaxID = 0) Then
            errStr = "Can't create fax object ! Error code : " + Str(Form1.FAX1.FaxError)
            MsgBox errStr, vbOKOnly
        Else
            Form1.FAX1.SetFaxParam FaxID, FP_SEND, PageNum
            ...
            If bError <> True Then
                ...
                If ImmediateButton.Value = True Then
                    errorsend = Form1.FAX1.SendNow(PortListBox.List(PortListBox.ListIndex), FaxID)
                ElseIf QueueButton.Value = True Then
                    errorsend = Form1.FAX1.SendFaxObj(FaxID)
                End If
                If (errorsend) Then
