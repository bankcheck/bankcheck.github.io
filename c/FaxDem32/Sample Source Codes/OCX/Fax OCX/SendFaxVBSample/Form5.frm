...
Private Sub CommandOK_Click()
    ...
    If (Form1.FAX1.GetPortStatus(PortList.List(PortList.ListIndex)) = 0) Then
        ...
        End If
    Else: MsgBox "Cannot close the port. Port is in use!", vbExclamation + vbOKOnly, "Warning", 0, 0
    End If
