...
uses OpenDlg, AboutDlg, CloseDlg;
...
begin
    FAX1.CloseAllPorts;
    EventListBox.Items.Add('This sample shows how to receive a fax through COM port.');
    EventListBox.Items.Add('To receive a fax open a COM port by choosing "Open Com Port..."');
    EventListBox.Items.Add('from Fax menu and selecting from the available ports, then wait for');
    EventListBox.Items.Add('a fax to be received. The sample saves the received fax in the file');
    EventListBox.Items.Add('specified in the "Save As..." dialog. The dialog appears after');
    EventListBox.Items.Add('the fax was received. To close a port choose "Close Com Port..."');
    EventListBox.Items.Add('from Fax menu and select from the open ports.');
end;
