...
begin
        EventListBox.Items.Add('This sample will show how to open and close a COM port.');
        EventListBox.Items.Add('To open a COM port choose Open Com Port... from Fax menu');
        EventListBox.Items.Add('and select from the available ports. To close a COM port choose');
        EventListBox.Items.Add('Close Com Port... from Fax menu and select the port to be');
        EventListBox.Items.Add('closed if there is any open port.');
        FAX1.CloseAllPorts;
end;
