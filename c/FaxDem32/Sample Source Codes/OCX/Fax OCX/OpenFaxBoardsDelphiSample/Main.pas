...
uses AboutDlg, CloseDlg, GammaInit, BrookTrout, dlginit, NMSInit;
...
begin
    FAX1.CloseAllPorts;
    EventListBox.Items.Add('This sample will show how to open and close a channel.');
    ...
    EventListBox.Items.Add('To close a channel choose "Close Channel..." from Fax menu');
    EventListBox.Items.Add('and select the channel to be closed if there is any open channel.');
end;
