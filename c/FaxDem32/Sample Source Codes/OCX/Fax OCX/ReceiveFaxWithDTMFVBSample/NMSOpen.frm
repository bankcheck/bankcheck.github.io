...
Private Sub CommandOK_Click()
    ...
    If (errcode <> 0) Then
        ...
        Exit Sub
    Else
        Form1.FAX1.RecvDTMF ChannelList.List(ChannelList.ListIndex), CInt(DTMFNMS.Text), 20
...
Private Sub DTMFNMS_KeyPress(KeyAscii As Integer)
