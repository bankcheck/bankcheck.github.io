...
uses AboutDlg, CloseDlg, GammaInit, BrookTrout,
  dlginit, NMSInit;
...
begin
    FAX1.CloseAllPorts;
    EventListBox.Items.Add('This sample shows how to receive a fax through Brooktrout, Dialogic,');
    EventListBox.Items.Add('Gammalink or NMS channel and get the DTMF if DTMF was sent.');
    EventListBox.Items.Add('To open a channel choose one of the Open menu items from Fax menu');
    EventListBox.Items.Add('according to your board type and select from the available channels.');
    EventListBox.Items.Add('The sample saves the received fax in the file specified in the Save As...');
    EventListBox.Items.Add('dialog which appears after the fax was received. The sample will inform');
    EventListBox.Items.Add('you about the received DTMF in this textbox at the end of fax receiving.');
    EventListBox.Items.Add('To close a channel choose Close Channel... from Fax menu and select');
    EventListBox.Items.Add('the channel to be closed if there is any open channel.');
end;
