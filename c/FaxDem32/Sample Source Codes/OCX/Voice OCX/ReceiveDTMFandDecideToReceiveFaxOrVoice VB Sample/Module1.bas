...
Public Const cnsHangup = 0
Public Const cnsDial = 1
Public Const cnsAnswer = 2
Public Const cnsOffHook = 3
Public Const cnsPlay = 4
Public Const cnsRecord = 5
Public Const cnsSendFax = 6
Public Const cnsRecFax = 7
Public Const cnsSendDTMF = 8
Public Const cnsWaitDTMF = 9
Public Const cnsSendSignal = 10
Public Const cnsTransfer = 11
Public Const cnsExit = 100
