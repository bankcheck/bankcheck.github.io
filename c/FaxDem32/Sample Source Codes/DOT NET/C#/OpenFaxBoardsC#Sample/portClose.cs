...
namespace FaxcppDemo
{
	...
	public class portClose : System.Windows.Forms.Form
	{
		...
		private void OK_button_Click(object sender, System.EventArgs e)
		{
			...
			if (parent.axFAX1.BrooktroutChannelsOpen.Length==0 && parent.axFAX1.DialogicChannelsOpen.Length==0 && parent.axFAX1.GammaChannelsOpen.Length==0 && parent.axFAX1.NMSChannelsOpen.Length==0)
