...
namespace FaxcppDemo
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Text = "Fax ActiveX Control - C# .NET ReceiveFax Sample";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			textBox1.Items.Add("This sample shows how to receive a fax through COM port.");
			textBox1.Items.Add("To receive a fax open a COM port by choosing \"Open Com Port...\"");
			textBox1.Items.Add("from Fax menu and selecting from the available ports, then wait for");
			textBox1.Items.Add("a fax to be received. The sample saves the received fax in the file");
			textBox1.Items.Add("specified in the \"Save As...\" dialog. The dialog appears after");
			textBox1.Items.Add("the fax was received. To close a port choose \"Close Com Port...\"");
			textBox1.Items.Add("from Fax menu and select from the open ports.");
