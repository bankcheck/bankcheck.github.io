...
namespace FaxcppDemo
{
	...
	public class DialogicOpen : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// Header_checkBox
			// 
			this.Header_checkBox.Location = new System.Drawing.Point(16, 160);
			...
			// DTMF_checkBox
			// 
			this.DTMF_checkBox.Location = new System.Drawing.Point(120, 160);
			this.DTMF_checkBox.Name = "DTMF_checkBox";
			this.DTMF_checkBox.Size = new System.Drawing.Size(56, 16);
			this.DTMF_checkBox.TabIndex = 11;
			...
			this.Controls.Add(this.DTMF_checkBox);
		...
		private void OK_button_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				if (DTMF_checkBox.Checked)
					parent.axFAX1.RecvDTMF(parent.m_ActualFaxPort, 5, 20);
