...
namespace FaxcppDemo
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.MenuItem menuBrookDebugInfo;		
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.menuBrookDebugInfo = new System.Windows.Forms.MenuItem();
			...
			// menuBrookDebugInfo
			// 
			this.menuBrookDebugInfo.Index = 5;
			this.menuBrookDebugInfo.Text = "Brooktrout debug info";
			this.menuBrookDebugInfo.Click += new System.EventHandler(this.menuBrookDebugInfo_Click);
			// 
			// menuItem7
			// 
			...
			this.Text = "Fax ActiveX Control - C# .NET Sample";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			axFAX1.EnableDebugForBrooktrout(0);
		...
		private void menuBrookDebugInfo_Click(object sender, System.EventArgs e)
		{
			if (this.menuBrookDebugInfo.Checked == false) 
			{	
				this.menuBrookDebugInfo.Checked = true;
				axFAX1.EnableDebugForBrooktrout(6);
			}
			else 
			{
				this.menuBrookDebugInfo.Checked = false;
				axFAX1.EnableDebugForBrooktrout(0);
			}	
		}		
	}
