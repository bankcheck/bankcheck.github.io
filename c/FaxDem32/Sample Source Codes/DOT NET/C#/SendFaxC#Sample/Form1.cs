...
namespace FaxcppDemo
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Text = "Fax ActiveX Control - C# .NET SendFax Sample";
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			textBox1.Items.Add("This sample shows how to send a fax using a COM port.");
			textBox1.Items.Add("To open a COM port choose \"Open Com Port...\" from Fax menu");
			textBox1.Items.Add("and select from the available ports. To send a fax select \"Send...\"");
			textBox1.Items.Add("from Fax menu, specify the file you would like to send and the");
			textBox1.Items.Add("destination phone number. You can send the fax using the selected");
			textBox1.Items.Add("port if checking \"Immediate\" radio button or put the fax in queue");
			textBox1.Items.Add("by checking \"Queue\" button.");
			textBox1.Items.Add("To close a port choose \"Close Com Port...\" from Fax menu and");
			textBox1.Items.Add("select from the open ports.");
		}
		...
		{
			if (axFAX1.AvailablePorts.Length>0) SetComportMenu(true);
