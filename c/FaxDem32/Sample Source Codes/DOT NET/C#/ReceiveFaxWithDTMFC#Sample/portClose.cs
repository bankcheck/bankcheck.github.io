...
namespace FaxcppDemo
{
	...
	public class portClose : System.Windows.Forms.Form
	{
		...
		private void OK_button_Click(object sender, System.EventArgs e)
		{
			...
			if (parent.axFAX1.GetPortStatus((string)PortListBox.SelectedItem)==0)
			{
				if (parent.axFAX1.ClosePort((string)PortListBox.SelectedItem) == 0)
				{
			...
			else MessageBox.Show("Cannot close the channel. Channel is in use!");
