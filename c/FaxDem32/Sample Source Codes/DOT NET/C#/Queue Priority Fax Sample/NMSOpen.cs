...
namespace FaxcppDemo
{
	...
	public class NMSOpen : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Channel_listBox.Size = new System.Drawing.Size(160, 134);
			this.Channel_listBox.TabIndex = 0;
			// 
			// OK_button
			// 
			this.OK_button.Location = new System.Drawing.Point(192, 40);
			...
			this.Cancel_button.Location = new System.Drawing.Point(192, 80);
			...
			// Header_checkBox
			// 
			this.Header_checkBox.Location = new System.Drawing.Point(8, 176);
			...
			this.Protocol_comboBox.Location = new System.Drawing.Point(8, 232);
			this.Protocol_comboBox.Name = "Protocol_comboBox";
			this.Protocol_comboBox.Size = new System.Drawing.Size(256, 21);
			this.Protocol_comboBox.TabIndex = 2;
			// 
			// label2
			// 
			...
			// Digits_textBox
			// 
			this.Digits_textBox.Location = new System.Drawing.Point(104, 270);
			...
			this.Digits_textBox.TabIndex = 3;
		...
		private void Digits_textBox_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				if (Digits_textBox.Text[0]<48 || Digits_textBox.Text[0] > 57)
				{
					if (digits!=null)	Digits_textBox.Text=digits;
					Digits_textBox.SelectAll();
				}
