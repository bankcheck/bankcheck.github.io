...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Text = "Fax ActiveX Control - Visual Basic .NET OpenComPorts Sample"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        currdir = CurDir()
        FAX1.CloseAllPorts()
        MessageBox.Items.Add("This sample will show how to open and close a COM port.")
        MessageBox.Items.Add("To open a COM port choose Open Com Port... from Fax menu")
        MessageBox.Items.Add("and select from the available ports. To close a COM port choose")
        MessageBox.Items.Add("Close Com Port... from Fax menu and select the port to be")
        MessageBox.Items.Add("closed if there is any open port.")
