...
#End Region
    ...
    Private Sub ClosePort_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Static i, j, portindex, spaceindex As Integer
    ...
    Private Sub OKButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OKButton.Click
        ...
        port = PortList.SelectedItem
        index = port.IndexOf(":")
        If (index <> -1) Then
            port = port.Substring(0, index)
        End If
        If (Not pparent.FAX1.ClosePort(port)) Then
            If (index <> -1) Then

                Dim portindex As Integer
                Dim spaceindex As Integer
                portindex = pparent.PortsAndClasses.IndexOf(port)
                spaceindex = pparent.PortsAndClasses.IndexOf(" ", portindex)
                pparent.PortsAndClasses = pparent.PortsAndClasses.Substring(0, portindex) + pparent.PortsAndClasses.Substring(spaceindex + 1)
            End If
            If (PortList.Items.Count = 1) Then
                pparent.MenuClosePort.Enabled = False
                pparent.MenuShowManager.Enabled = False
