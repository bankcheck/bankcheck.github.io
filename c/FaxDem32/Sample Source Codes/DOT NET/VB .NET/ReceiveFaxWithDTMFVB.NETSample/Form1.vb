...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Text = "Fax ActiveX Control - Visual Basic .NET ReceiveFaxWithDTMF Sample"
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        currdir = CurDir()
        FAX1.CloseAllPorts()
        MessageBox.Items.Add("This sample shows how to receive a fax through Brooktrout, Dialogic,")
        MessageBox.Items.Add("Gammalink or NMS channel and get the DTMF if DTMF was sent.")
        ...
        MessageBox.Items.Add("The sample saves the received fax in the file specified in the Save As...")
        MessageBox.Items.Add("dialog which appears after the fax was received. The sample will inform")
        MessageBox.Items.Add("you about the received DTMF in this textbox at the end of fax receiving.")
        MessageBox.Items.Add("To close a channel choose Close Channel... from Fax menu and select")
        MessageBox.Items.Add("the channel to be closed if there is any open channel.")
