...
#End Region
    ...
    Private Sub OKButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OKButton.Click
        ...
        If (Not pparent.FAX1.ClosePort(port)) Then
            pparent.MessageBox.Items.Add(port + " was closed")
        ...
        End If
        If (Len(pparent.FAX1.BrooktroutChannelsOpen) = 0 And Len(pparent.FAX1.DialogicChannelsOpen) = 0 And Len(pparent.FAX1.GammaChannelsOpen) = 0 And Len(pparent.FAX1.NMSChannelsOpen) = 0) Then
            pparent.MenuClosePort.Enabled = False
        End If
        Enabled = True
