// OpenComPortsDlg.cpp : implementation file
//

#include "stdafx.h"
#include "OpenComPorts.h"
#include "OpenComPortsDlg.h"
...
COpenComPortsDlg::COpenComPortsDlg(CWnd* pParent /*=NULL*/)
	: CDialog(COpenComPortsDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(COpenComPortsDlg)
...
void COpenComPortsDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(COpenComPortsDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(COpenComPortsDlg, CDialog)
	//{{AFX_MSG_MAP(COpenComPortsDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CREATE()
...
/////////////////////////////////////////////////////////////////////////////
// COpenComPortsDlg message handlers

BOOL COpenComPortsDlg::OnInitDialog()
{
...
void COpenComPortsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR COpenComPortsDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

int COpenComPortsDlg::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void COpenComPortsDlg::OnDestroy() 
{
	CDialog::OnDestroy();
...
void COpenComPortsDlg::OnOpenport() 
{
...
void COpenComPortsDlg::OnCloseport() 
{
