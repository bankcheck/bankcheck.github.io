...
void CdlgSendFax::OnOK() 
{
	...
	At this point, FAXCPP supports the normal transmission protocol.
	...
	*/
	...
	/*
	TSFaxImage union stores information about a page of a fax. The members of the structure are:
