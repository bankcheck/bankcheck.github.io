...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "ProgID",
                            "GeneXpert2", g_szProgID, 40, szFile);

    GetPrivateProfileString(MY_PROFILE, "LogPath",
                            "C:\\MOXA\\GeneXpert2\\LOG\\", g_szLogPath, 260, szFile);
    AddBslash(g_szLogPath);

    GetPrivateProfileString(MY_PROFILE, "FlagFile",
                            "C:\\MOXA\\GeneXpert2\\FLAG.DAT", g_szFlagFile, 260, szFile);
	...
	GetPrivateProfileString(MY_PROFILE, "OutBuffer",
                            "C:\\MOXA\\GeneXpert2\\TEMP\\buf.dat", g_szOutBufferFile, 260, szFile);

	GetPrivateProfileString(MY_PROFILE, "POSITIVE",
                            "500", g_Pos, 5, szFile);
    GetPrivateProfileString(MY_PROFILE, "NEGATIVE",
                            "0", g_Neg, 5, szFile);
