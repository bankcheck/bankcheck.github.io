...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "ProgID",
                            "OMNICELL", g_szProgID, 40, szFile);
    GetPrivateProfileString(MY_PROFILE, "LogPath",
                            "C:\\HL7\\OMNICELL\\LOG\\", g_szLogPath, 260, szFile);
    AddBslash(g_szLogPath);

    GetPrivateProfileString(MY_PROFILE, "ADTInBoxPath",
                            "C:\\HL7\\OMNICELL\\INBOX\\", g_szADTInBoxPath, 260, szFile);
    AddBslash(g_szADTInBoxPath);
	GetPrivateProfileString(MY_PROFILE, "RXFInBoxPath",
                            "C:\\HL7\\OMNICELL\\INBOX\\", g_szRXFInBoxPath, 260, szFile);
    AddBslash(g_szRXFInBoxPath);
    GetPrivateProfileString(MY_PROFILE, "RXPInBoxPath",
                            "C:\\HL7\\OMNICELL\\INBOX\\", g_szRXPInBoxPath, 260, szFile);
    AddBslash(g_szRXPInBoxPath);

	GetPrivateProfileString(MY_PROFILE, "BackupInBoxPath",
                            "C:\\HL7\\OMNICELL\\INBOX.BAK\\", g_szBackupInBoxPath, 260, szFile);
    ...
    g_nRXFPort = GetPrivateProfileInt(MY_PROFILE, "RXF_Port", 0, szFile);
    g_nRXPPort = GetPrivateProfileInt(MY_PROFILE, "RXP_Port", 0, szFile);
