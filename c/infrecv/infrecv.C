...
char        g_szProgID[40] = "infrecv";
char        g_szPrgName[80] = "HKAH Infinity Receiver";
HANDLE      g_hServerStopEvent = NULL;
HANDLE      g_hCom = INVALID_HANDLE_VALUE;
BOOL        g_bQuit = FALSE;
BOOL        g_bLog = FALSE;
BOOL        g_bDebug = FALSE;
char        g_szFlagFile[260] = "C:\\MOXA\\infrecv\\FLAG.DAT";
char        g_szLogPath[260] = "C:\\MOXA\\infrecv\\LOG\\";
char        g_szOutBoxPath[260] = "C:\\MOXA\\infrecv\\OUTBOX\\";
char        g_szCodeFile[260] = "D:\\MOXA\\infrecv\\CODE.DAT";
