...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "ProgID",
                            "GeneXpert", g_szProgID, 40, szFile);

    GetPrivateProfileString(MY_PROFILE, "LogPath",
                            "C:\\MOXA\\GeneXpert\\LOG\\", g_szLogPath, 260, szFile);
    AddBslash(g_szLogPath);

    GetPrivateProfileString(MY_PROFILE, "FlagFile",
                            "C:\\MOXA\\GeneXpert\\FLAG.DAT", g_szFlagFile, 260, szFile);
	...
	GetPrivateProfileString(MY_PROFILE, "OutBuffer",
                            "C:\\MOXA\\GeneXpert\\TEMP\\buf.dat", g_szOutBufferFile, 260, szFile);
