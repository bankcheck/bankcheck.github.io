...
// service should end
//
char    g_szProfile[260] = "patho.ini";
HANDLE  g_hServerStopEvent = NULL;
int		g_sleep = 1000;
char    g_szDBServer[80] = "139.168.200.1";
char    g_szFileServer[80] = "139.168.200.1";
char    g_szPrgName[80] = "HKAH pathology service";
char    g_szLogPath[260] = "C:\\MOXA\\patho\\log";
char    g_szBackupPath[260] = "C:\\MOXA\\patho\\INBOX.BAK";
char    g_szInBoxPath[260] = "C:\\MOXA\\patho\\INBOX";
