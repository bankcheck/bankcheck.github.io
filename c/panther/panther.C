...
int         g_nComPort = 1;
OVERLAPPED  g_o;
char        g_szPrgName[80] = "HKAH panther";
...
char        g_szCodeFile[260] = "C:\\MOXA\\panther\\CODE.DAT";
char        g_szTempPath[260] = "C:\\MOXA\\panther\\TEMP\\";
char        g_szBackupInBoxPath[260] = "C:\\MOXA\\panther\\INBOX.BAK\\";
char        g_szInBoxPath[260] = "C:\\MOXA\\panther\\INBOX\\";
char        g_szInBoxDataPath[260] = "C:\\MOXA\\panther\\INBOX\\";
char        g_szOutBoxPath[260] = "C:\\MOXA\\panther\\OUTBOX\\";
char        g_szLogPath[260] = "C:\\MOXA\\panther\\LOG\\";
char        g_szRateFile[260] = "C:\\MOXA\\panther\\RATE.DAT";
char		g_szBufferFile[260] = "C:\\MOXA\\panther\\TEMP\\buf.dat";
...
int          g_ls = LS_FREE;
int			g_mode;
BOOL		g_bCutCheckDigit;
unsigned int	g_nLabnumLen;
...
VOID ServiceStart (DWORD dwArgc, LPTSTR *lpszArgv)
{
    ...
    WriteLog("Delete buffer file: %s", g_szBufferFile);
    RecvProc();
