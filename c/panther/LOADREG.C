...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "LogPath",
                            "C:\\MOXA\\panther\\LOG\\", g_szLogPath, 260, szFile);
    AddBslash(g_szLogPath);
    GetPrivateProfileString(MY_PROFILE, "BackupInBoxPath",
                            "C:\\MOXA\\panther\\INBOX.BAK\\", g_szBackupInBoxPath, 260, szFile);
    AddBslash(g_szBackupInBoxPath);
    GetPrivateProfileString(MY_PROFILE, "InBoxPath",
                            "C:\\MOXA\\panther\\INBOX\\", g_szInBoxPath, 260, szFile);
    AddBslash(g_szInBoxPath);
    GetPrivateProfileString(MY_PROFILE, "InBoxDataPath",
                            "C:\\MOXA\\panther\\INBOX\\", g_szInBoxDataPath, 260, szFile);
    AddBslash(g_szInBoxDataPath);
    GetPrivateProfileString(MY_PROFILE, "OutBoxPath",
                            "C:\\MOXA\\panther\\OUTBOX\\", g_szOutBoxPath, 260, szFile);
    AddBslash(g_szOutBoxPath);
    GetPrivateProfileString(MY_PROFILE, "TempPath",
                            "C:\\MOXA\\panther\\TEMP\\", g_szTempPath, 260, szFile);
    AddBslash(g_szTempPath);

    GetPrivateProfileString(MY_PROFILE, "CodeFile",
                            "C:\\MOXA\\panther\\CODE.DAT", g_szCodeFile, 260, szFile);
    GetPrivateProfileString(MY_PROFILE, "RateFile",
                            "C:\\MOXA\\panther\\RATE.DAT", g_szRateFile, 260, szFile);

	GetPrivateProfileString(MY_PROFILE, "Buffer",
                            "C:\\MOXA\\panther\\TEMP\\buf.dat", g_szBufferFile, 260, szFile);
    ...
    g_bCutCheckDigit = GetPrivateProfileInt(MY_PROFILE, "CutCheckDigit", 0, szFile);
    g_nLabnumLen = GetPrivateProfileInt(MY_PROFILE, "labnum_length", 8, szFile);
