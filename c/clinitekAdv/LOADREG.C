...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "TempPath",
                            "D:\\MOXA\\urt\\TEMP\\", g_szTempPath, 260, szFile);
