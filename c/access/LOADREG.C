...
int LoadRegVal(void)
{
    ...
    GetPrivateProfileString(MY_PROFILE, "InstrumentID",
                            "ACCESS2", g_InstrumentID, 260, szFile);
    return 0;
}
