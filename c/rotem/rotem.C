...
char        g_szProgID[40] = "rotem";
char        g_szPrgName[80] = "HKAH rotem Service";
HANDLE      g_hServerStopEvent = NULL;
HANDLE      g_hCom = INVALID_HANDLE_VALUE;
BOOL        g_bQuit = FALSE;
BOOL        g_bLog = FALSE;
BOOL        g_bDebug = FALSE;
char        g_szFlagFile[260] = "C:\\MOXA\\rotem\\FLAG.DAT";
char        g_szLogPath[260] = "C:\\MOXA\\rotem\\LOG\\";
char        g_szOutBoxPath[260] = "C:\\MOXA\\rotem\\OUTBOX\\";
char		g_szTempPath[260];
char		g_szInBoxPath[260];
char        g_szCodeFile[260] = "C:\\MOXA\\rotem\\CODE.DAT";
char        g_szOutBufferFile[260] = "C:\\MOXA\\rotem\\TEMP\\BUF.DAT";
