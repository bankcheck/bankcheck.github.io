...
int main(int argc, char** argv)
{
	...
	// we leave the original vs. decoded data comparison to diff in the Makefile
...
int main(int argc, char** argv)
{
	...
	if (argc < 3)
	{
		printf("please supply 2 filenames: input, decoded\n");
		exit(-1);
	}
	...
	//encodedFile = fopen(argv[2], "r");
	decodedFile = fopen(argv[2], "wb");
	
	decode(inputFile, decodedFile);
